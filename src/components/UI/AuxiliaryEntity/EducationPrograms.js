...
export default class EducationPrograms extends Component {
  ...
  componentDidMount() {
    axios
      .get(`${config.get("serverAddress")}/api/academicDetails`)
      .then(response => {
  ...
  hadleDelete = params => {
    axios
      .delete(
        `${config.get("serverAddress")}/api/academicDetails/` + params._id
      )
      .then(response => {
  ...
  handleSubmitEdit = params => {
    ...
    axios
      .put(
        `${config.get("serverAddress")}/api/academicDetails/` +
          this.state.programId,
        dataToPut
      )
      .then(res => {
        const _programs = this.state.programs.filter(
          m => m._id !== this.state.programId
        );
            ...
            <Form>
              ...
              <Form.Group controlId="formGroupprogramType">
                ...
                >
                  ...
                  <option value="מקצועות כלכליים פיננסיים">
