          ...
          >
            ...
            <Form.Group>
              ...
              <h2>נהלי התוכנית</h2>
                ...
                <ul>
                  <li >הפעילות הינה 3 או 4 שעות שבועיות, לפי מה שסוכם איתך בהתאם למסלול המלגה שלך</li>
                  <li>	שליש מזמן הפעילות מוקדש לחברותא – לימוד מתוך ארוך הספרים היהודי, דיון והכרות. זמן החברותא הוא חלק בלתי נפרד מהפעילות. אם יש צורך מסיבה נקודתית לוותר על שעת החברותא, יש לאשר זאת פרטנית מול הרכז</li>
                  <li>	הפעילות הינה לאורך כל שנת הלימודים, כולל בעת הצורך חופשת הסמסטר ותקופת המבחנים של מועדי א' בקיץ</li>
                  <li>את הפעילות יש לקיים באופן רציף מידי שבוע, ולא לדחוס אותה לתקופות קצרות. </li>
                  <li>-	מיקום הפגישות נקבע בין הסטודנט המתגבר לסטודנט החרדי, מתוך התחשבות הדדית</li>
                  <li>-	מידי שבועיים יש לדווח על הפעילות במערכת הדיווחים המקוונת. דיווח באיחור של חודש ומעלה עלול לגרום לביטול קבלת המלגה</li>
                  <li>-	שיחת משוב עם הרכז בין 1-3 בשנה הינה חובתו של הסטודנט המתגבר</li>
                  <li>-	יש להשיב לשיחות, הודעות ומיילים לכל המאוחר תוך 3 ימי עבודה. במקרה של נסיעה לחו"ל/מילואים/סיבה אחרת לאי זמינות ממושכת, יש לעדכן מראש את הרכז. </li>
                  <li>-	במהלך השנה יתקיימו שני מפגשים קבוצתיים בשעות הערב, בתאריכים שיינתנו לך מספר שבועות מראש. מפגשים אלה הינם חובתך, ואי הגעה אליהם עלולה לפגוע בקבלת המלגה ו/או בהשתתפות בפרויקט. יש בעת הצורך אף לפספס קורס אקדמי למטרת ההגעה למפגשים. במקרה של היעדרות/סימן שאלה על ההגעה, יש ליצור קשר בהקדם האפשרי עם הרכז.</li>
                  <li>-	דיווח כוזב מהווה עבירה פלילית ומוסרית ויגרור שלילת הזכאות למלגה או לכל תמורה אחרת מבליבה חומה</li>
                  <li>-	בכל מקרה בו תופסק פעילותך שלא באחריותך, ולאחר התייעצות כנדרש ובהסכמת מינהלת "בליבה חומה", תעמיד לך המינהלת סטודנט או פעילות חלופית בהתאם למקובל. סירובך להיענות להמשך פעילות שתוצע לך, בהתאם לאפשרות, תפקיע את מחויבותה של מינהלת "בליבה חומה",לתשלום יתרת המלגה.</li>
                  <li>-	מינהלת "בליבה חומה", רשאית, בכל עת, מטעמים ענייניים, להפסיק פעילותך או להחליט שלא להעניק לך את המלגה כלל, או להקטינה, או לדחות את הענקתה או לא לשלם חלק כלשהו של המלגה שטרם שולם לך במועד כלשהו, בכל אחד או יותר מן המקרים הבאים: א. אם יתברר כי לא מילאת את כל המטלות המפורטות במסמך זה, או לא מילאת את כולן במלואן, לפי התנאים המפורטים לעיל; ב. אם הפסקת את פעילותך, באופן חלקי או מלא, ללא אישור. ג. אם פעילותך הופסקה ע"י מינהלת "בליבה חומה", משום שלדעתה לא עמדת במטלות כמפורט לעיל או נמצאת בלתי מתאים לפעילות בפרוייקט. אם הפסקת השתתפותך בפרוייקט מסיבה שאינה נתונה בשליטתך, כגון מחלה, יועבר אליך החלק היחסי במלגה, ובתנאי שמילאת לפחות 3 חודשי השתתפות בפרוייקט.</li>
                  <li>-	בינך ובין "בליבה חומה" לא מתקיימים יחסי עובד מעביד, לא במפורש ולא במשתמע. פעילותך מזכה אותך לכל היותר בקבלת מלגה - לפי התנאים המפורטים במסמך זה, ואינה מזכה אותך בתשלומים אחרים כלשהם.</li>
                  <li>-	פרטי הזיהוי שלך לרבות שם ומספר תעודת זהות, ועובדת פעילותך במסגרת בליבה חומה" ו/או מספר השעות שבצעת כסטודנט, עשויים להיות מועברים למוסד הלימודים שלך ו/או לכל גורם ציבורי ו/או אחר שמעורב במימון מלגתך. כמו כן, הינך מסכים לכך שהגורם המממן יעביר נתוני מידע אודותיך למינהלת "בליבה חומה", לפי קריטריונים של הגורם המממן, לצורך מתן המלגה/ההטבה. מובהר כי פרטיך האישיים ונתוני המידע כאמור לעיל, יועברו בין מינהלת "בליבה חומה", לבין הגורם המממן אך ורק לצורך המוזכר לעיל.</li>
                  <li>-	בתום שנת הפעילות, תתבקש למלא סקר משוב קצר, שמשכו כ-10 דקות. מילוי הסקר קריטי לצוות התוכנית כדי ללמוד מההצלחות והטעויות. מילוי הסקר הינו חובה והכרחי עבור קבלת המלגה.יודגש כי גם סטודנטים שמכל סיבה עזבו את הפעילות במהלך השנה, מחוייבים במילוי הסקר.</li>
                </ul>
                
                <p>
                  <b>עבור מלגאי אימפקט:</b><br></br>
                
    כחלק מהשתתפותך בפרוייקט בליבה חומה, ועמידה בתנאים המפורטים לעיל, תדווח "בליבה חומה" על עמידתך במחוייבויות שלך ל"אימפקט". בהתאם לכך, "אימפקט" תעניק לך מלגה.  כל עוד עמדת במלוא המטלות המוטלות עליך, בהתאם להוראות מינהלת "בליבה חומה" ובהתאם לשיקול דעתה, יועבר ל"אימפקט" דיווח מלא בהתאם. מובהר כי המלגה שלך תשולם ישירות על ידי "אימפקט", בכפוף לקריטריונים של "אימפקט" ולעמידתך בכל המחויבויות שלך כלפיהם. 

                </p>
                <p>
                <b>עבור מלגאי שח"ק:</b><br></br>
כחלק מהשתתפותך בפרוייקט בליבה חומה, ועמידה בתנאים המפורטים לעיל, תדווח "בליבה חומה" על עמידתך במחוייבויות שלך לשח"ק. בהתאם לכך, שח"ק תעניק לך מלגה.  כל עוד עמדת במלוא המטלות המוטלות עליך, בהתאם להוראות מינהלת "בליבה חומה" ובהתאם לשיקול דעתה, יועבר לשח"ק  דיווח מלא בהתאם. מובהר כי המלגה שלך תשולם ישירות על ידי שח"ק, בכפוף לקריטריונים של שח"ק ולעמידתך בכל המחויבויות שלך כלפיהם.
                ...
                <p>
                 ...
                 <ul>
                   <li>-	עבור שעות ההתנדבות עבורן אני מעוניין לקבל נקודות זכות אקדמיות, יש לדווח לא רק במערכת הדיווחים של "בליבה חומה" מידי שבועיים, אלא גם במערכת דיווחים שמוסד הלימודים שלי יבקש, בתדירות שתיקבע על ידו. ללא דיווח כפול, אין לנו יכולת להתחייב שנקודות הזכות יינתנו</li>
                  <li>-	הגעה ל-2 אירועי החובה של בליבה חומה, איננה נכללת במניין השעות עבור הדיווח למוסד האקדמי</li>
                  <li>-	בעבור 40 השעות (שעה = 60 דקות) הראשונות של פעילותך בפרוייקט, ובכפוף לעמידתך בנהלי התוכנית המפורטים במסמך זה, נודיע למוסד האקדמי שלך כי עמדת במכסת השעות הנדרשות, במסגרת פרוייקט קבלת נ"ז בגין מעורבות חברתית. יש להדגיש כי נושא הרישום לקורס במוסד האקדמי, בירור הנושאים האקדמיים כגון השתלבות הנ"ז במסלול התואר שלך וכו - הינם באחריותך.</li>
                <li>-	אם תבצע במסגרת התוכנית שעות נוספות מעבר ל40 השעות המוגדרות לצרכי נ"ז, תוכל לקבל על שעות אלה מלגה. מלגה זו תחושב בתעריף של 42 ש"ח לשעה. כל עוד עמדת במלוא המטלות המוטלות עליך, בהתאם להוראות מינהלת "בליבה חומה" ובהתאם לשיקול דעתה, תהיה זכאי לקבל את מלוא המלגה האמורה בכפוף להוראות מסמך זה. המלגה תועבר אליך ע"י מינהלת "בליבה חומה" או ע"י גופים אחרים עימם "בליבה חומה" קשורה, במועד סיום תקופת המלגה ובשיעור יחסי התואם את מספר המפגשים שבוצעו בפועל עד מועד זה.</li>
                </ul> 
                
                <p>
                  <b>הקודמות, ומקבלים מלגה ישירות מבליבה חומה:</b><br></br>
                  </p>
                  <ul>
                    <li>כחלק מהשתתפותך בפרוייקט בליבה חומה, ועמידה בתנאים המפורטים לעיל, תוענק מלגת עידוד בסך עד 5,000 ₪ בכפוף להחלטה של מנהל הפרוייקט והגופים התורמים לפרוייקט, ולזמני העברת הכספים ל"בליבה חומה" על ידם. המלגה תוענק עבור 120 שעות פעילות.  כל עוד עמדת במלוא המטלות המוטלות עליך, בהתאם להוראות מינהלת "בליבה חומה" ובהתאם לשיקול דעתה, תהיה זכאי לקבל את מלוא המלגה האמורה בכפוף להוראות מסמך זה. המלגה תועבר אליך ע"י מינהלת "בליבה חומה" או ע"י גופים אחרים עימם "בליבה חומה" קשורה, במועד סיום תקופת המלגה ובשיעור יחסי התואם את מספר המפגשים שבוצעו בפועל עד מועד זה.</li>
                  <li>סכום המלגה עלול להתחייב בתשלום מס הכנסה, אולם מינהלת "בליבה חומה", לא  תנכה מס זה במקור. הסכום המתקבל כמלגה נכלל בקטגורית הסכומים העלולים להתחייב במס, וסטודנט המשתכר ממקור נוסף חייב לדווח לשלטונות המס גם על סכום זה.</li>
                  </ul>
                
                <p>הנני מצהיר כי קראתי את הנהלים, והם מקובלים עלי. ידוע לי כי אי עמידה בנהלים עלולה לגרום להדחה מהתוכנית ולאי קבלת המלגה/התמורה.</p>
