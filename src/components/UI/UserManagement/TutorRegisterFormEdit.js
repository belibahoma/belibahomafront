...
class TutorRegisterForm extends Component {
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            _id: this.props.tutorInfo._id,
            id: this.props.tutorInfo.id,
            fname: this.props.tutorInfo.fname,
            lname: this.props.tutorInfo.lname,
            ...
            activityArea: this.props.tutorInfo.activityArea,
            institute: this.props.tutorInfo.institute,
            mainStudy: this.props.tutorInfo.mainStudy,
            ...
            activeStatus: this.props.tutorInfo.activeStatus,
            isFinnishPreparatory: this.props.tutorInfo.isFinnishPreparatory,
            isGraduated: this.props.tutorInfo.isGraduated,
            isFoundJob: this.props.tutorInfo.isFoundJob,
            isJobInStudyFelid: this.props.tutorInfo.isJobInStudyFelid,
            // until here is the common part
            isImpact: this.props.tutorInfo.isImpact,
            ...
            additionalTopics: this.props.tutorInfo.additionalTopics,
            isActive: this.props.tutorInfo.isActive
        }
    };
    ...
    handleSubmit = val => {
        if (
            ...
            axios
                .put(`${config.get("serverAddress")}/api/tutors/` + this.state._id, dataToPut, {
