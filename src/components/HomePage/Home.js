      ...
      <div id="container" style={{ textAlign: "right" }}>
        ...
        <Jumbotron>
          <div id="main_jumbo">
            ...
            <img alt="logo" id="bh_logo" src={logo} height="380" width="380" />
          </div>
        </Jumbotron>
          ...
          <div class="d-inline-flex flex-md-equal w-100 my-md-3 pl-md-3">
            ...
            <div class="bg-light w-50 mr-md-3 pt-3 px-3 pt-md-5 px-md-5 text-center overflow-hidden">
              <div class="mx-3 ">
                ...
                <p class="lead">
                  !יוצרים גשר בין אוכלוסיות סטודנטים במדינת ישראל
                </p>
              </div>
              <div
              ...
              >
                <p class="text-right text-white p-3">
                  תכנית 'בליבה חומה' פועלת מזה 5 שנים, על מנת לאפשר לצעירים
                  חרדים להשתלב בהצלחה במערכת ההשכלה הגבוהה בישראל בדרכם לרכוש
                  פרנסה בכבוד, ובנוסף ליצור שינוי חברתי ביחסי המגזרים השונים
                  בישראל
                  <br />
                  .התכנית הוקמה על ידי צעירים בעקבות שבר גדול בו חזו במהלך מאבק
                  חברתי בין ציבור הסטודנטים לציבור החרדי בשנת 2010
                  <br />
                  .בליבה חומה' החלה לפעול בירושלים, ובמהרה התרחבה גם לאיזור גוש
                  דן, לבאר שבע ולחיפה
                  <br />
                  .עד היום השתתפו בפרויקט כ-700 סטודנטים
                </p>
              </div>
              <Button variant="outline-dark m-3" onClick={this.toggleModal_pdf}>
                קרא עלינו עוד
              </Button>
            </div>
            <div class="bg-dark w-25 mr-md-3 pt-3 px-3 pt-md-5 px-md-5 text-center text-white overflow-hidden">
